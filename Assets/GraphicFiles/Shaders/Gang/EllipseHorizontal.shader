...
float sdEllipse( in float2 p, in float2 r )
{
    p = abs(p);
...
// }
    ...
    float2 ra = float2(0.7,0.2) + 0.2*sin(0.1 * TIME * float2(1.1,1.3) + float2(0,1));
	ra = 0.7 + float2(0.4,0.2)*cos(TIME * 0.52 + float2(1.0 ,2.0));
